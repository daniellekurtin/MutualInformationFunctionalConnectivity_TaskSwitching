...
sed -e"s/cope1/${cope}/g" "$FSFdir"/Study2_${Model}_3rdlevel.fsf > "$GROUPFSFDir"/Study2_${Model}_3rdlevel_${cope}.fsf

feat "$GROUPFSFDir"/Study2_${Model}_3rdlevel_${cope}.fsf
