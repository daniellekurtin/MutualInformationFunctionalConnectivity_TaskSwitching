function plot_nodes_in_cortex_DK (V)
...
if taskName=='TaskRest'
    load ShirerLabels_TaskRest.txt
else
    load ShirerLabels_SwitchStay.txt
end

MNI_coord=aal116_mm_coords/10;    % hers was originally over 10, but are coords are in MNI space, so we should be ok
clear aal_cog
